...
export const INTENTION_MAP = {
  ...
  bottine_bebe: { semelle: 'eva', montage: 'cousu_retourne', material: 'nappa_vegetal', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.85, prompt_descriptor: 'baby ankle boot, soft upper, velcro closure, padded collar' },
