...
export const materiaux = {
  cuir: {
    ...
    nappa_vegetal: {
      label: 'Nappa Tannage Végétal',
      epaisseur: { min: 0.5, max: 0.9, unite: 'mm' },
      usages: ['tige', 'doublure'],
      segments: ['bebe', 'enfant', 'femme'],
      resistance_flexion: 25000,
      certification: 'LWG',
    },
    chevreau_vegetal: {
      label: 'Chevreau Végétal',
      epaisseur: { min: 0.5, max: 0.8, unite: 'mm' },
      usages: ['tige', 'doublure'],
      segments: ['bebe', 'femme'],
      resistance_flexion: 22000,
      certification: 'LWG',
    },
    veau: {
      label: 'Cuir de veau',
  ...
  textile: {
    ...
    coton_bio: {
      label: 'Coton Bio OEKO-TEX',
      epaisseur: { min: 0.3, max: 0.6, unite: 'mm' },
      usages: ['tige', 'doublure'],
    ...
    textile_technique: {
      ...
      epaisseur: { min: 0.3, max: 0.7, unite: 'mm' },
      usages: ['tige'],
      segments: ['bebe', 'enfant', 'femme', 'homme'],
      resistance_flexion: 85000,
      certification: null,
    },
    toile_enduite: {
      label: 'Toile enduite',
...
export const semelles = {
  types: {
    ...
    gomme_recyclee: {
      label: 'Gomme Recyclée',
      densite: { min: 0.8, max: 1.1 },
      durete_shore: { min: 45, max: 65, echelle: 'A' },
      usure_din: { max: 180, unite: 'mm³' },
      segments: ['bebe', 'enfant'],
    },
  },
  composants: {
...
export const montages = {
  ...
  cousu_retourne: {
    label: 'Cousu Retourné',
    description: 'Tige retournée et cousue à la semelle, très souple pour bébé',
    segments: ['bebe', 'enfant'],
    cout_relatif: 2,
    flexibilite: 'très haute',
    reparabilite: 'moyenne',
  ...
  opanka: {
    label: 'Opanka',
    description: 'Semelle relevée et cousue sur le bord de la tige, construction très flexible',
    segments: ['bebe', 'enfant', 'femme'],
    cout_relatif: 2.5,
    flexibilite: 'très haute',
    reparabilite: 'moyenne',
  ...
  soude_souple: {
    label: 'Soudé Souple',
    description: 'Assemblage par soudure haute fréquence, ultra-léger et flexible',
    segments: ['bebe'],
    cout_relatif: 1.2,
    flexibilite: 'très haute',
    reparabilite: 'faible',
...
export const INTENTION_MAP = {
  ...
  bottine: { semelle: 'tr', montage: 'cousu_blake', material: 'vachette', finition: 'cire', doublure: 'microfibre_respirante', confidence: 0.88, prompt_descriptor: "children's ankle boot, structured toe, durable construction, child proportions, lace-up or zip" },
  ...
  chausson: { semelle: 'eva', montage: 'cousu_strobel', material: 'agneau', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.92, prompt_descriptor: 'baby bootie, soft rounded toe, infant first shoe' },
  premiers_pas: { semelle: 'eva', montage: 'cousu_retourne', material: 'nappa_vegetal', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.88, prompt_descriptor: 'baby first walking shoe, flexible sole, ankle support, rounded toe' },
  sandale_bebe: { semelle: 'eva', montage: 'colle', material: 'agneau', finition: 'naturel', doublure: 'sans_doublure', confidence: 0.82, prompt_descriptor: 'baby sandal, open toe, soft ankle strap, flexible sole' },
  bottine_bebe: { semelle: 'eva', montage: 'cousu_retourne', material: 'nappa_vegetal', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.85, prompt_descriptor: 'baby ankle bootie, ultra-soft rounded silhouette, chubby proportions, infant-sized, soft padded collar, no hard structure' },
  'bottine bébé': { semelle: 'eva', montage: 'cousu_retourne', material: 'nappa_vegetal', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.85, prompt_descriptor: 'baby ankle bootie, ultra-soft rounded silhouette, chubby proportions, infant-sized, soft padded collar, no hard structure' },
  'premiers pas': { semelle: 'eva', montage: 'cousu_retourne', material: 'nappa_vegetal', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.88, prompt_descriptor: 'baby first walking shoe, flexible sole, ankle support, rounded toe' },
  'chausson tricot': { semelle: 'eva', montage: 'cousu_strobel', material: 'coton_bio', finition: 'naturel', doublure: 'textile_coton_bio', confidence: 0.85, prompt_descriptor: 'knitted baby bootie, soft yarn, elastic opening, cozy infant shoe' },
