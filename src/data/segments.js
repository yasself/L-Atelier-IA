...
const segments = {
  bebe: {
    ...
    contraintes: {
      ...
      tanningAllowed: ['vegetal', 'aldehyde'],
      tanningForbidden: ['chrome'],
      montageForbidden: ['cousu_blake', 'cousu_goodyear'],
      soleRequirements: ['antiderapant', 'flexible'],
      safetyRequirements: ['sans_chrome', 'hypoallergenique', 'non_toxique', 'oeko_tex'],
      fermeturesForbidden: ['lacets', 'zip', 'boucle', 'bride'],
      finitionsForbidden: ['vernis', 'brillant', 'patine', 'antique'],
      certificationRequise: ['OEKO_TEX'],
    },
  ...
  enfant: {
    ...
    contraintes: {
      ...
      tanningAllowed: ['vegetal', 'aldehyde', 'chrome_certifie'],
      tanningForbidden: ['chrome_vi'],
      montageForbidden: ['cousu_goodyear'],
      soleRequirements: ['antiderapant', 'resistant_abrasion'],
      safetyRequirements: ['sans_chrome_vi', 'resistant_abrasion'],
      fermeturesForbidden: ['zip intérieur'],
      finitionsForbidden: ['vernis', 'patine', 'antique', 'métallisé'],
    },
    materiaux_recommandes: {
...
export const TYPES_CHAUSSURES = {
  bebe: ['Chausson', 'Bottillon', 'Sandale', 'Basket souple', 'Babouche', 'Premiers pas', 'Bottine bébé', 'Chausson tricot'],
