...
const segments = {
  ...
  femme: {
    ...
    materiaux_recommandes: {
      tige: ['vachette', 'chevreau', 'agneau', 'veau', 'nubuck', 'pu', 'microfibre', 'box_calf', 'cuir_cire', 'cuir_waterproof', 'knit', 'neoprene'],
  ...
  homme: {
    ...
    montages_recommandes: ['colle', 'cousu_blake', 'cousu_goodyear', 'injection', 'ago', 'norwegian_welt', 'strobel'],
